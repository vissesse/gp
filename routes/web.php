...
Route::group(['prefix' => 'cadeira'], function () {
    ...
    Route::get('{curso}/curso', [App\Http\Controllers\CadeiraController::class, 'cadeirasListFilter'])->name('cadeiras_filter'); 
    ...
    Route::get('{cadeira}/turma/{turma}/pauta', [App\Http\Controllers\PautaController::class, 'show'])->name('Admin_cadeira_pauta');
